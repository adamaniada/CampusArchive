        ...
        <div class="table-responsive">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    @else
                        <img class="img-thumbnail rounded bd-placeholder-img rounded-circle" width="140" height="140" src="{{ $profil->avatar }}" alt="Photo de profil" srcset="">
                    @endif
                </div>
                <div class="text-end">
                    <div>{{ ('Nom : ') }}</div>
                ...
                <div>
                    ...
                    <div>{{ $profil->role }}</div>
                    <div>{{ $profil->created_at }}</div>
                    <div>{{ $profil->updated_at }}</div>
                </div>
            </div>
        </div>
    </div>
