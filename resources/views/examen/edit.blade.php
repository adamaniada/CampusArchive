    ...
    <div class="row justify-content-center">
        <div class="col-md-6 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update-examen-data', [$designation_univ, $designation_ufr, $designation_filiere, $examen->id]) }}">
                        @csrf
                        {{ $examen }}
                            <div class="mb-3">
                                <label for="module">Module</label>
                                <input id="module" type="text" class="form-control" name="module" value="{{ $examen->nom }}" required>
                            </div>
